...
$.fn.customPhotoViewer = function () {
    ...
    var $thumbs = $('.thumbnail-anchor');                      //Container for thumbnail


    $(document).on('click','.thumbnail-anchor',function(e){        //When a thumb is clicked on
        ...
        if(cache.hasOwnProperty(src)){                  //If cache contains this image
            ...
            $img.on('load',function(){                  //When image has loaded
                ...
                // $frame.attr("href", src);       // Adds link of current image to photo box href
